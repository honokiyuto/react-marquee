...
### 1\. `scroll` behaviorの場合

<Marquee
  behavior="scroll"
  direction="right"
  style={{ width: '100%', height: 'fit-content', backgroundColor: '#f0f0f0' }}
>
  ★☆★☆ようこそReactMarqueeのscrollへ★☆★☆
</Marquee>
...
<img src="img/scroll-figure.png" alt="marquee-scroll-rightの図解" width="500" />
...
※[GitHub - honokiyuto/react-marquee](https://github.com/honokiyuto/react-marquee)
